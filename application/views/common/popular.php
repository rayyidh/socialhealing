    ...
    <div class="row">
      <div class="span4">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="<?php echo base_url() ?>home/latest">LATEST</a></li>
             ...
             <?php if(isset($popular)) : foreach ($popular as $r) : ?>
              <div class="post">
                ...
                <div style="float:right; font-size:12px; margin-bottom:0 0;">
                  <a class="btn btn-primary" href="<?php echo base_url() ?>$this->db->order_by("view", "desc"); <?php echo $r->post_id; ?>">Read more>></a>
                </div>  
              </div>
            </div><!-- Close post -->
          <?php endforeach;  ?>
